...
class Clocc(LightEffect):
    def __init__(self, renderer, coords):
        super().__init__(renderer, coords, "The Clocc", EffectType.ONLY_2D)
        ...
        self.frame_color = self.add_parameter("Frame Color", ParamType.COLOR, "#2bff00")
    ...
    def update(self):
        for i, coord in enumerate(self.coords):
            ...
            if abs(dist_from_center) < 300:
                self.renderer[i] = self.frame_color.get()
